...
document.write('as ultimas 3 letras do seu nome: ',nome.slice(nome.indexOf(" ")+1,nome.indexOf(" ",nome.indexOf(" ")+2,'<br>')))

document.write("substituindo O por E: ",nome.replace(/o/g,"e"))
